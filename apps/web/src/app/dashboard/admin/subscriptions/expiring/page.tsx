...
export default function ExpiringPlansPage() {
  return (
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-[#E3E5E8] pb-4">
        <div>
          <h1 className="text-xl font-semibold text-[#1A1F36] flex items-center gap-2">
            <AlertTriangle className="h-5 w-5 text-[#1A6FDB]" />
            Expiring Plans
          </h1>
          <div className="text-xs text-[#8A94A6] mt-1">Schools with plans expiring in the next 30 days.</div>
        </div>
